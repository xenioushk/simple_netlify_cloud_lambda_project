...
/***/ "./src/scripts/modules/SecretForm.js":
/*!*******************************************!*\
  !*** ./src/scripts/modules/SecretForm.js ***!
  \*******************************************/
...
var SecretForm = /*#__PURE__*/function () {
  function SecretForm(parameters) {
    _classCallCheck(this, SecretForm);
  ...
  return _createClass(SecretForm, [{
    key: "events",
    value: function events() {
      var _this = this;
      this.secretForm.addEventListener("submit", function (e) {
        e.preventDefault();
    ...
    value: function handleFormSubmission(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("MISSING_ENV_VAR".API_URL, {
        ...
        _this2.cotentArea.innerHTML = response.data;
      })["catch"](function (error) {
        _this2.cotentArea.innerHTML = "Invalid password!";
        _this2.passwordField.value = "";
        _this2.passwordField.focus();
      });
    }
  }]);
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SecretForm);
...
/* harmony import */ var _scripts_modules_SecretForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/modules/SecretForm */ "./src/scripts/modules/SecretForm.js");
// Load SCSS Files.
